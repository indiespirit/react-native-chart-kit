...
4. For terminal use, run `npx --package=react-native-chart-kit chart-kit docs /docs/react-native/charts/line`. Add `--json` when structured output is needed. The CLI requires package version 7.0.3 or later.
